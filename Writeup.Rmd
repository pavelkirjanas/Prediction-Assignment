...
```{r}
set.seed(28589) 
inTrain <- createDataPartition(trainCleaned$classe, p=0.60, list=FALSE)
...
So, the estimated accuracy of the model is 99.36% and the estimated out-of-sample error is 0.63%.
